...
export default new Vuex.Store({
  ...
  actions: {
    ...
    rateUpdater({ dispatch }, { product_id, ratePack }) {
      ...
      fetch("/mini/all_products/user/product_rated/" + product_id, {
        credentials: "include",
        headers: {
        ...
        .then(data => {
          if (data.Error) {
            ...
            console.log("Successful Rating", data);
    ...
    addProdToBuy({ dispatch }, { purchases }) {
      ...
      fetch("/mini/all_products/allpurchase_view", {
        credentials: "include",
        headers: {
          "Content-Type": "application/json"
        },
    ...
    addProductSale({ dispatch }, { currentProduct }) {
      fetch("/mini/all_products/provider/product_added", {
        credentials: "include",
        headers: {
          "Content-Type": "application/json"
        },
    ...
    editProductSale({ dispatch }, { currentEditProduct, productId }) {
      ...
      fetch("/mini/all_products/provider/product_edited/" + productId, {
        credentials: "include",
        headers: {
          "Content-Type": "application/json"
        },
        ...
        .then(data => {
          if (data.Error) {
            ...
            console.log("Successful Editing", data);
            dispatch("fetchAllProducts");
          }
        })
        .catch(function(error) {
    ...
    deleteProviderProduct({ dispatch }, { currentDelProd, productId }) {
      ...
      fetch("/mini/all_products/delete/" + productId, {
        credentials: "include",
        headers: {
          "Content-Type": "application/json"
        },
    ...
    fetchUserIdProducts({ commit, getters }) {
      ...
      fetch("/mini/all_products/one_selected/purchase_view/" + userId, {
        credentials: "include",
        method: "GET"
      })
        .then(response => {
    ...
    fetchingAllPurchasesViewBoardUser({ commit }) {
      fetch("/mini/all_products/user_dashboard/final_view", {
        credentials: "include",
        method: "GET"
      })
        .then(response => {
    ...
    getUserSignedUp({ commit, dispatch }, payload) {
      ...
      fetch("/mini/all_product/registering", {
        credentials: "include",
        headers: {
          "Content-Type": "application/json"
        },
        ...
        .then(userData1 => {
          if (userData1.Error) {
            console.log("fail on register", userData1);
            commit("setUserAuth", false);
          } else {
            console.log("Success", userData1);
    ...
    getuserLogOut({ commit }) {
      fetch("/api/logout", {
        ...
        .then(userData => {
          console.log("Request success: ", userData);
          commit("setUserAuth", false);
          router.push("/logIn");
          setTimeout(() => {
            location.reload();
